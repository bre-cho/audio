        ...
        for index, artifact in enumerate(runtime_artifacts):
            ...
            contracts.append(
                AudioArtifactContract(
                    ...
                    generation_mode=str(artifact.get("generation_mode") or "unknown"),
                    provider_verified=bool(artifact.get("provider_verified", False)),
                    audio_contains_signal=bool(artifact.get("audio_contains_signal", False)),
                    signal_rms=artifact.get("signal_rms"),
                    signal_peak=artifact.get("signal_peak"),
